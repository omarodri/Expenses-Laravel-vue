...
Route::get('/expense_reports/{id}/sendMail', 'ExpenseReportController@sendMail');
Route::post('/expense_reports/{id}/confirmSendMail', 'ExpenseReportController@confirmSendMail');
